	...
	<body>
		<div class="wrapper">			
			...
			<div class="pull-right">	
				<a href="javascript:void(0);" class="btn btn-primary" title="Click here to export all students data to CSV" onclick="javascript:export_CSV('1');">Export To CSV</a>
				<a href="javascript:void(0);" class="btn btn-primary" title="Click here to export all students data to Excelsheet" onclick="javascript:export_CSV('0');">Export To Excelsheet</a>
			</div>
			<br><br>
			<div>
		...
		<script src="/students/public/js/admin/student.js" type="text/javascript"></script>
	</body>		
</html>
